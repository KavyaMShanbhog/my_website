...
<h1>LIST OF REGISTERED STUDENTS</h1>
    ...
    <?php
                            ...
                            echo '<tr>
                                    ...
                                    echo '<td><button class="b1"><strong><a href="process1.php?sid='.$row['phno'].'">Approve</a></strong></button>';
                                    echo '<td><button class="b2"><strong><a href="process_dis.php?sid='.$row['phno'].'">Disapprove</a></strong></button>
